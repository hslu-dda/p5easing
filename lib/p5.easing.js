...
/**
 * Calculates the number of steps required for a given duration at a specified frame rate.
 *
 ...
 * @returns {number} The number of steps required for the animation.
 */
...
/**
 * Eases a value based on the number of frames elapsed using a specified easing function.
 *
 * @param {number} startFrame - The frame at which the easing animation started.
 * @param {number} durationFrames - The total number of frames for the easing animation.
 * @param {number} startValue - The starting value of the animation.
 * @param {number} endValue - The ending value of the animation.
 * @param {string} easingFunctionName - The name of the easing function to use.
...
/**
 * Eases a value based on the current step of an animation using a specified easing function.
 *
